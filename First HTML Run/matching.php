...
function bsearch($thelist, $head, $tail, $newentry)
{
	...
	echo "middle is " . $middle->matchnumber . "head is " . $head->matchnumber . "tail is " . $tail->matchnumber . "</br>";
	if(sublistlength($head, $tail) == 1)
	{
		echo "winding down, base case";
